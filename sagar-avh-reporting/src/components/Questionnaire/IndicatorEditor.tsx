...
import { Check, AlertTriangle, Wand2, Info } from 'lucide-react';
...
const IndicatorEditor: React.FC<IndicatorEditorProps> = ({ 
  ...
  const handleDraftIndicator = async () => {
    if (!indicator) return;
    ...
    // Mock draft content based on indicator type
    let draftValue = '';
    switch (indicator.type) {
      ...
      case 'numeric':
        ...
        break;
      case 'text':
        draftValue = 'Sagar Cement has implemented comprehensive ESG governance framework with board-level oversight and dedicated sustainability committee.';
        break;
      case 'multiple-choice':
        draftValue = 'Yes';
        break;
      default:
        draftValue = 'Sample response generated by AI assistant.';
    }
    
    setValue(draftValue);
    if (indicator) {
      onValueChange(indicator.id, draftValue, false, false, '');
    }
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          <button 
            className="flex items-center gap-2 text-indigo-600 hover:text-indigo-800 px-3 py-1.5 border border-indigo-200 hover:bg-indigo-50 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
            onClick={handleDraftIndicator}
            disabled={isDrafting}
          >
            <Wand2 size={16} />
            <span>AI Assist</span>
